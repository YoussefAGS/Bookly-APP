...
class FeatureNewBooksCubit extends Cubit< FeatureNewBooksState> {
  FeatureNewBooksCubit(this.featuredBookUseCase) : super(FeatureNewBooksInitial());
  ...
  Future<void> FetchFeatureNewBook() async {
    ...
    resalt.fold((failure) => emit(FeatureNewBooksFailure(failure.message)),
            (book) => emit(FeatureNewBooksSuccess(book)));
  }
}
